...
{
    return fseek((FILE*)cookie, (long)off, whence);
}
...
"                                 0: RAW (muxed into M4A)\n"
"                                 1: ADIF\n"
"                                 2: ADTS (default, muxed into AAC)\n"
"                                 6: LATM MCP=1\n"
"                                 7: LATM MCP=0\n"
...
int __cdecl main(int argc, char **argv)
{
    ...
    if (m4af) {
        ...
        padding = (uint32_t)(frame_count * aacinfo.frameLength - frames_read - delay);

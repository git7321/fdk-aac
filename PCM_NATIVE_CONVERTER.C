...
static
__inline float pcm_i2f(int32_t n)
{
    union {
        int32_t ivalue;
        float fvalue;
...
static
__inline double pcm_i2d(int64_t n)
{
    union {
        int64_t ivalue;
        double fvalue;
...
static
__inline int32_t pcm_s8_to_s32(int8_t n)
{
    return n << 24;
}
static
__inline int32_t pcm_u8_to_s32(uint8_t n)
{
    return (n << 24) ^ 0x80000000;
}
static
__inline int32_t pcm_s16le_to_s32(int16_t n)
{
    return m4af_ltoh16(n) << 16;
}
static
__inline int32_t pcm_s16be_to_s32(int16_t n)
{
    return m4af_btoh16(n) << 16;
}
static
__inline int32_t pcm_u16le_to_s32(uint16_t n)
{
    return (m4af_ltoh16(n) << 16) ^ 0x80000000;
}
static
__inline int32_t pcm_u16be_to_s32(uint16_t n)
{
    return (m4af_btoh16(n) << 16) ^ 0x80000000;
}
static
__inline int32_t pcm_s24le_to_s32(uint8_t *p)
{
    return p[0]<<8 | p[1]<<16 | p[2]<<24;
}
static
__inline int32_t pcm_s24be_to_s32(uint8_t *p)
{
    return p[0]<<24 | p[1]<<16 | p[2]<<8;
}
static
__inline int32_t pcm_u24le_to_s32(uint8_t *p)
{
    return pcm_s24le_to_s32(p) ^ 0x80000000;
}
static
__inline int32_t pcm_u24be_to_s32(uint8_t *p)
{
    return pcm_s24be_to_s32(p) ^ 0x80000000;
}
static
__inline int32_t pcm_s32le_to_s32(int32_t n)
{
    return m4af_ltoh32(n);
}
static
__inline int32_t pcm_s32be_to_s32(int32_t n)
{
    return m4af_btoh32(n);
}
static
__inline int32_t pcm_u32le_to_s32(int32_t n)
{
    return m4af_ltoh32(n) ^ 0x80000000;
}
static
__inline int32_t pcm_u32be_to_s32(int32_t n)
{
    return m4af_btoh32(n) ^ 0x80000000;
}
static
__inline float pcm_f32le_to_f32(int32_t n)
{
    return pcm_i2f(m4af_ltoh32(n));
}
static
__inline float pcm_f32be_to_f32(int32_t n)
{
    return pcm_i2f(m4af_btoh32(n));
}
static
__inline float pcm_f64le_to_f32(int64_t n)
{
    return (float)pcm_i2d(m4af_ltoh64(n));
}
static
__inline float pcm_f64be_to_f32(int64_t n)
{
    return (float)pcm_i2d(m4af_btoh64(n));
}
...
static __inline pcm_reader_t *get_source(pcm_reader_t *reader)
{
